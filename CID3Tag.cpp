...
//================== static data ================
int CID3Tag::nMaxFileNameLen = 20;      //Always want at least some width
int CID3Tag::nMaxTitleLen = 20;         //Always want at least some width
int CID3Tag::nMaxArtistLen = 20;        //Always want at least some width
int CID3Tag::nMaxAlbumLen = 20;         //Always want at least some width
int CID3Tag::nMaxTrackLen = 20;         //Always want at least some width
//================== static data ================
...
void CID3Tag::Extract(char * pPathAndFile) {
//******************************************************************************
//* 
//******************************************************************************
    CFile   MP3File;
...
void CID3Tag::Extract_FileName(char * pPathAndFile) {
//******************************************************************************
//* 
//******************************************************************************
    unsigned int     nLen = 0;
...
char CID3Tag::Extract_Header_Tag(char * pFileContents) {
//******************************************************************************
//* 
//******************************************************************************
    char fFound;
...
void CID3Tag::Extract_Frames(char * pFileContents) {
//******************************************************************************
...
char CID3Tag::Check_For_Frame_Header(FrameHeaderTag gFrameHeader) {
//******************************************************************************
...
CID3Tag::FrameTypeTag CID3Tag::Determine_Frame_Type(FrameHeaderTag gFrameHeader) {
//******************************************************************************
...
void CID3Tag::Extract_Title(char * pFileContents) {
//******************************************************************************
//* The song title
//******************************************************************************
...
void CID3Tag::Extract_Artist(char * pFileContents) {
//******************************************************************************
//* Self Evident
//******************************************************************************
    string fTextEncoding = "???";
...
void CID3Tag::Extract_Album(char * pFileContents) {
//******************************************************************************
//* Self Evident
//******************************************************************************
    int nTextLength = 0;
...
void CID3Tag::Extract_Track(char * pFileContents) {
//******************************************************************************
...
void CID3Tag::Extract_TrackLen(char * pFileContents) {
//******************************************************************************
//* This is the number of the track on the album.  
//******************************************************************************
    int nWorkNumber = 0;
...
void CID3Tag::Extract_Unknown_Frame(char * pFileContents) {
//******************************************************************************
//* 
//******************************************************************************
//    int     nFrameLength;
...
void CID3Tag::Extract_Text(char * sText, char * pFileContents) {
//******************************************************************************
...
int CID3Tag::Convert_ID3Len(int ID3Len) {
//******************************************************************************
//* 
//******************************************************************************
...
//******************************************************************************
//*--------------------------------*/
    return CID3Tag::nMaxFileNameLen;
}
...
//******************************************************************************
//=====================================
char * CID3Tag::File_Name(void) {
//=====================================
    return sFileName;
}

//=====================================
char * CID3Tag::Title(void) {
//=====================================
    return sTitle;
}

//=====================================
char * CID3Tag::Artist(void) {
//=====================================
    return sArtist;
}

//=====================================
char * CID3Tag::Album(void) {
//=====================================
    return sAlbum;
}

//=====================================
char * CID3Tag::Track(void) {
//=====================================
    return sTrack;
}
